...
abstract class AbstractMoney implements Money {
	private static final long serialVersionUID = 3054902299244979099L;
	 ...
	 * specification, read return. However this method is up to specification as
	 * defined in {@link Comparable}
	 * <p>
	...
	public int compareTo(final Money other) {
		if (other instanceof MoneyLong) {
			return compareTo((MoneyLong) other);
		} else {
			return compareTo((MoneyBigDecimal) other);
		}
	}
